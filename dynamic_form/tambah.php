  ...
  <div class="container" align="center" style="padding : 0px 0px;">
    ...
    <div class="row" style="width:100%; padding-top : 8px;" align="center">
      ...
      <div class="col-md-8" align="left">
        <input id="versi" name="nama" type="text" value="" placeholder="Isi disini..." class="form-control" readonly="readonly" />
      </div>
    </div>
    <div class="row" style="width:100%; padding-top : 8px;" align="center">
      <div class="col-md-2" align="left">
      ...
      <div class="col-md-8" align="left">
        <input id="tanggal" name="tanggal" type="date" value="" placeholder="Isi disini..." class="form-control" readonly="readonly" />
      </div>
    </div>
    <div class="row" style="width:100%; padding-top : 8px;" align="center">
      <div class="col-md-2" align="left">
    ...
    <div class="row" style="width:100%; padding-top : 8px;" align="center">
      ...
      <div class="col-md-8" align="left">
        <input id="menu" name="menu" placeholder="Isi disini..." class="form-control" readonly="readonly" />
      </div>
    </div>
    <div class="row" style="width:100%; padding-top : 8px;" align="center">
      <div class="col-md-2" align="left">
      ...
      <div class="col-md-8" align="left">
        <input id="release" name="release" placeholder="Isi disini..." class="form-control" readonly="readonly" />
      </div>
    </div><br>
